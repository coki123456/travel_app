...
-- Crear un usuario "admin" temporal para viajes existentes
INSERT INTO "User" ("id", "email", "name", "password", "createdAt", "updatedAt")
VALUES ('temp-admin-user', 'admin@temp.com', 'Admin Temporal', '$2a$10$dummy.hash.value', NOW(), NOW());

-- Asignar todos los viajes existentes al usuario admin temporal
UPDATE "Trip" SET "ownerId" = 'temp-admin-user' WHERE "ownerId" IS NULL;

-- Hacer ownerId obligatorio
